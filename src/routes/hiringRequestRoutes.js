...
hiringRouter.get('/:id', authenticate, getRequest)
hiringRouter.patch('/:id/decision', authenticate, authorizeRoles('lawyer'), verifyOrigin, validate(hiringDecisionSchema), decideRequest)
